...
const Finalists = () => {
  ...
  const finalists: Finalist[] = [
    ...
    { id: 'ed3', name: 'Mr Lindokuhle Mokoena', category: 'HCP Educator of the Year', image: '/images/finalists/Lindokuhle.jpeg', voteCode: 'ED03' },
    ...
    { id: 'me3', name: 'Dr Nokuzola Mokoena', category: 'HCP Mentor of the Year', image: '/images/finalists/Nokuzola.jpeg', voteCode: 'ME03' },
    ...
    { id: 'rs4', name: 'Dr Thozama Siyotula', category: 'Rising Star HCP of the Year', image: '/images/finalists/Thozama.jpeg', voteCode: 'RS04' },
    ...
    { id: 'cd4', name: 'Haniefa Bi Allee', category: 'HCP Charity Driver of the Year', image: '/images/finalists/Haniefa.jpeg', voteCode: 'CD04' },
